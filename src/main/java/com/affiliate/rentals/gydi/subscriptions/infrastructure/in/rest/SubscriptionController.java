 ...
 *
 * <p>This controller exposes endpoints for managing user subscriptions, including
 * creating subscriptions, changing plans, and canceling subscriptions.</p>
 *
 * <p><b>Endpoints:</b></p>
 * <ul>
...
public class SubscriptionController {
    ...
    @Operation(
        ...
        description = "Changes the authenticated user's subscription plan. " +
    ...
    @Operation(
        ...
        description = "Cancels the authenticated user's subscription. " +
