...
public record UpdatePropertyRequest(
                ...
                @Size(min = 10, max = 100, message = "Title must be between 10 and 100 characters") String title,
                ...
                @Min(value = 0, message = "Bedrooms cannot be negative") Integer bedrooms,

                @Min(value = 0, message = "Bathrooms cannot be negative") Integer bathrooms,

                @Min(value = 1, message = "Max guests must be at least 1") Integer maxGuests,

                @Pattern(regexp = "APARTMENT|HOUSE|VILLA|CABIN|STUDIO|CONDO|BUNGALOW|OTHER", message = "Invalid property type") String propertyType,
