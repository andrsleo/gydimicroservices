 ...
 *
 * <p>
 * This record encapsulates the data required to create a user profile.
 * It includes validation annotations to ensure data integrity at the API
 * boundary.
 * </p>
 *
 ...
 * @param dateOfBirth               the user's date of birth (must be in the
 *                                  past)
 * @param gender                    the user's gender (male, female, non_binary,
 *                                  prefer_not_to_say, other)
 * @param bio                       user biography/description (max 1000
 *                                  characters)
 ...
 * @param profileVisibility         profile visibility (public, private,
 *                                  connections)
...
public record CreateUserProfileRequest(
                ...
                @Pattern(regexp = "male|female|non_binary|prefer_not_to_say|other", message = "Gender must be one of: male, female, non_binary, prefer_not_to_say, other") String gender,
                ...
                @Size(max = 5, message = "Language code must not exceed 5 characters") String preferredLanguage,

                @URL(message = "Cover image URL must be valid") String coverImageUrl,

                @URL(message = "Website URL must be valid") @Pattern(regexp = "^https?://.*", message = "Website URL must start with http:// or https://") String websiteUrl,

                Map<String, String> socialLinks,

                Map<String, Object> preferences,

                @Pattern(regexp = "public|private|connections", message = "Profile visibility must be one of: public, private, connections") String profileVisibility,
