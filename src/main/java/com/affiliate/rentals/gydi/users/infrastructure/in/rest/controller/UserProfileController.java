 ...
 *
 * <p>This controller provides RESTful endpoints for CRUD operations on user profiles.
 * It follows REST best practices with appropriate HTTP methods and status codes,
 * utilizing Java 21 features and modern Spring Boot patterns.</p>
 *
...
public class UserProfileController {
    ...
    @Operation(
            ...
            description = "Creates a new profile for a user. Each user can only have one profile (1:1 relationship)."
    )
    @ApiResponse(
            responseCode = "201",
    ...
    @Operation(
            ...
            description = "Retrieves a user profile associated with a specific user (1:1 relationship)"
    )
    @ApiResponse(
            responseCode = "200",
            description = "Profile found",
     ...
     *
     * <p>This endpoint supports partial updates (PATCH semantics).
     * Only the fields provided in the request will be updated.</p>
     *
     * @param userId the user ID
    ...
    @Operation(
            ...
            description = "Updates an existing user profile. Supports partial updates - only provided fields are updated."
    )
    @ApiResponse(
            responseCode = "200",
    ...
    @Operation(
            ...
            description = "Deletes a user profile. Note: User profiles are automatically deleted when the user is deleted (CASCADE)."
    )
