 ...
 *
 * <p>This service handles the business logic for initiating a password reset process, including:</p>
 * <ul>
 ...
 * <ul>
 *   <li>Always returns success message regardless of email existence (prevents enumeration)</li>
...
public class RequestPasswordResetUseCase {
     ...
     * </ol>
     *
     * <p>If the user doesn't exist, silently succeeds to prevent email enumeration.</p>
     *
