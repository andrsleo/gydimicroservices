 ...
 * Adds security headers to prevent execution of malicious files and XSS attacks.
 *
 * <p><b>Security Headers Applied:</b></p>
 * <ul>
 *   <li><b>X-Content-Type-Options: nosniff</b> - Prevents MIME type sniffing (XSS protection)</li>
 *   <li><b>X-Frame-Options: DENY</b> - Prevents clickjacking attacks</li>
 *   <li><b>Content-Security-Policy</b> - Prevents script execution from uploaded files</li>
 *   <li><b>Cache-Control</b> - Configures caching for performance</li>
 * </ul>
 *
 * <p>This filter is automatically registered to intercept requests to {@code /uploads/*}</p>
 *
...
public class StaticResourceSecurityFilter implements Filter {
    ...
    public FilterRegistrationBean<StaticResourceSecurityFilter> staticResourceFilterRegistration(
        ...
        FilterRegistrationBean<StaticResourceSecurityFilter> registration =
