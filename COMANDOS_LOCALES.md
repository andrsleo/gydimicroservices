...
SPRING_PROFILES_ACTIVE=local DB_PASSWORD=***REMOVED*** JWT_SECRET=LjQx8OFV0448l3uEwdCQUw== JWT_REFERRAL_SECRET=HgFbV40cv1qE/oDxqc2DXA== AES_SECRET_KEY=b7e36bfca9c0b6dafded67f69ac929e5cd96bb19a266340ff05977e8d4594341 URL_HASHIDS_SALT=Aap4piesmxrF+OK08e+UKLHgJiuhWwofxereBOF9bJk= ./mvnw spring-boot:run
```
...
3. En "Environment variables" agrega:
   ```
   SPRING_PROFILES_ACTIVE=local;DB_PASSWORD=***REMOVED***;JWT_SECRET=...
   ```
